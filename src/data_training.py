...
def extract_target(
    ...
    train_df = pd.read_parquet(os.path.join(cfg.processed_dir, f"{cfg.file_name}_train_processed.parquet"))
    test_df = pd.read_parquet(os.path.join(cfg.processed_dir, f"{cfg.file_name}_test_processed.parquet"))
